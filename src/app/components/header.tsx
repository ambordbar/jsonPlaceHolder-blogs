...
export default function Header() {
    ...
    return (
        <header className="relative mx-4 mt-5 mb-20 text-background md:mx-16 lg:mx-28 xl:mx-36 2xl:mx-44">
          ...
          [--conic-position:from_70deg_at_center_top] opacity-100">
                                <div className="absolute w-full left-0 bg-slate-950 
          ...
          [--conic-position:from_290deg_at_center_top] opacity-100">
                                <div className="absolute w-full right-0 bg-slate-950 
            h-32 sm:h-36 md:h-40 bottom-0 z-20 
            [mask-image:linear-gradient(to_top,white,transparent)]"></div>
                            </div>
          ...
          w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl
          translate-y-12 scale-x-150 bg-slate-950 blur-2xl"></div>
          ...
          -translate-y-1/2 rounded-full bg-cyan-500 opacity-50 blur-3xl"></div>

                            {/* ✅ Smaller Cyan Section */}
                            <div className="absolute left-1/2 transform -translate-x-1/2 
          inset-auto z-30 h-[10rem] sm:h-[12rem] md:h-[14rem] lg:h-[16rem] 
          w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl
          -translate-y-[6rem] rounded-full bg-cyan-400 blur-2xl"></div>

                            {/* ✅ Cyan Line */}
                            <div className="absolute left-1/2 transform -translate-x-1/2 
          inset-auto z-50 h-0.5 w-full max-w-xs sm:max-w-md md:max-w-lg 
          lg:max-w-xl xl:max-w-2xl -translate-y-[7rem] bg-cyan-400"></div>

                            {/* ✅ Bottom Cyan Section */}
                            <div className="absolute left-1/2 transform -translate-x-1/2 
          inset-auto z-40 h-[6rem] sm:h-[8rem] md:h-[10rem] lg:h-[12rem] 
          w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl
          -translate-y-[12.5rem] bg-slate-950"></div>
